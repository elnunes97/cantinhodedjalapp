...
class _HomePageState extends State<HomePage> {
  ...
  List<Map<String, dynamic>> produtosComEstoqueBaixo = [];
  ...
  Future<void> _atualizarEstoque() async {
    ...
    setState(() {
      ...
      produtosComEstoqueBaixo = produtos.where((produto) {
              ...
              if (produtosComEstoqueBaixo.isNotEmpty)
                Card(
                  ...
                  child: ListTile(
                    ...
                    title: Text('Estoque baixo:', style: TextStyle(fontWeight: FontWeight.bold)),
                    subtitle: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: produtosComEstoqueBaixo.map((produto) {
                        return Text("${produto['nome']} (Qtd: ${produto['quantidade']})");
                      }).toList(),
                    ),
                  ),
                ),
                    ...
                    SingleChildScrollView(
                      child: Column(
                        children: [
                          _cardFormulario(),
                          SizedBox(height: 10),
                          Lottie.asset('assets/carrinho.json', width: 40, height: 40, repeat: true),
                    ...
                    Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 20),
                          Text("Total de vendas de hoje", textAlign: TextAlign.center, style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: Colors.black54)),
                          SizedBox(height: 10),
                          Text("XOF ${totalVendasDia.toStringAsFixed(2)}", textAlign: TextAlign.center, style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.green)),
                        ],
                      ),
                    )
                  ],
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            _inputField("Preço", _precoController, isNumber: true, readOnly: true),
            SizedBox(height: 10),
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    icon: _isLoading ? Lottie.asset('assets/loading.json', width: 40) : Icon(Icons.check_circle),
